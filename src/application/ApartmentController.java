...
public class ApartmentController  implements Initializable{
	...
	public void userCommercial(ActionEvent event) throws IOException {
		Parent root = FXMLLoader.load(getClass().getResource("CommercialPage.fxml"));
		stage = (Stage)((Node)event.getSource()).getScene().getWindow();
		scene=new Scene(root);
		stage.setScene(scene);
		stage.show();
	...
	public void rentNow(ActionEvent event) throws IOException {
		Parent root = FXMLLoader.load(getClass().getResource("RentViewPage.fxml"));
		stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
		scene = new Scene(root);
		stage.setScene(scene);
		stage.show();
    ...
    void prevPage(ActionEvent event) throws IOException {
    	 System.out.println("Prev Page");
	        Main up8 = new Main();
	            up8.changeScene("SearchBar.fxml");
    }
    ...
    void nextPage(ActionEvent event) throws IOException {
    	 System.out.println("Next Page");
	        Main up8 = new Main();
	            up8.changeScene("CommercialPage.fxml");
    }
